...
function OnboardingNavigator() {
  ...
  return (
    <Stack.Navigator id={undefined} screenOptions={{ headerShown: false, contentStyle: { backgroundColor: CANVAS }, animation: "slide_from_right" }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: CANVAS }} edges={["left", "right"]}>
      ...
      <NavigationContainer linking={linking}>
        <Stack.Navigator id={undefined} screenOptions={{ headerShown: false, contentStyle: { backgroundColor: CANVAS }, animation: "fade" }}>
          {showOnboarding ? (
