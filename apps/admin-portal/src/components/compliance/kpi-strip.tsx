...
const KPI_CONFIG = [
  ...
  { label: "Docs Pending",    status: "pending_submission", color: "text-white/50",      border: "border-glass-border",   bg: "bg-glass-100"         },
  { label: "Rejected",        status: "rejected",           color: "text-red-signal",    border: "border-red-glow/20",    bg: "bg-red-surface/10"    },
] as const;
