...
/**
 * Subscribe to cross-tab / cross-portal bus updates. Returns an unsubscribe.
 * The `storage` event fires in *other* tabs when this tab writes; same-tab
 * writes still need a manual refresh.
 */
