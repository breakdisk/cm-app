...
const ACCENT_RING  = "rgba(0, 255, 136, 0.35)";
const GRADIENT     = "linear-gradient(135deg, #00FF88 0%, #00B8D9 100%)";

// ─── Aurora with green tint ───────────────────────────────────────────────────

function PartnerAuroraBackground({ children }: { children: React.ReactNode }) {
  return (
    <div
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full opacity-15 blur-[120px] animate-aurora"
          style={{ background: "linear-gradient(135deg, #00FF88, #00B8D9)" }}
        />
        <div
          className="absolute -bottom-40 -right-20 h-[500px] w-[500px] rounded-full opacity-12 blur-[100px] animate-aurora"
          style={{
            background: "linear-gradient(135deg, #00CC6A, #A855F7)",
            animationDelay: "-4s",
          }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[400px] rounded-full opacity-8 blur-[90px] animate-aurora"
          style={{
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 8px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(0,255,136,0.06)",
            }}
          >
            {/* Logo */}
            <div className="mb-8 flex flex-col items-center gap-3">
              ...
              >
                <Zap className="h-6 w-6 text-canvas" strokeWidth={2.5} />
              </div>
              <div className="text-center">
                ...
                <p
                  className="mt-0.5 text-xs font-semibold uppercase tracking-[0.18em] font-mono"
              ...
              <p className="text-center text-sm text-white/50">
                Carrier &amp; partner operations access
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                style={{
                  background: loading ? "rgba(0,255,136,0.2)" : GRADIENT,
                  color: loading ? ACCENT_COLOR : "#050810",
