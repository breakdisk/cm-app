/**
 * Design tokens for the LogisticOS futuristic dark theme.
 * Single source of truth — mirrors tailwind.config.ts for use in
 * JS contexts (Three.js materials, Framer Motion variants, canvas drawing).
 */
...
/** Semantic color mapping for shipment statuses */
...
/** Framer Motion animation variants — reused across components */
