...
DROP POLICY IF EXISTS webhooks_tenant_isolation ON webhooks.webhooks;
DROP POLICY IF EXISTS deliveries_tenant_isolation ON webhooks.deliveries;

ALTER TABLE IF EXISTS webhooks.webhooks DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS webhooks.deliveries DISABLE ROW LEVEL SECURITY;
