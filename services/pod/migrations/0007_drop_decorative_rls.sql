...
DROP POLICY IF EXISTS pop_tenant_isolation ON pod.proofs_of_pickup;

ALTER TABLE IF EXISTS pod.proofs DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS pod.proofs_of_pickup DISABLE ROW LEVEL SECURITY;
