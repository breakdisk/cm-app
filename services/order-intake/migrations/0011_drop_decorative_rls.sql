...
ALTER TABLE IF EXISTS order_intake.shipments DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS order_intake.shipment_events DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS order_intake.shipment_pieces DISABLE ROW LEVEL SECURITY;
