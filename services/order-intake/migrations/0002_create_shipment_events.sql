...
CREATE TABLE order_intake.shipment_events (
...
CREATE INDEX idx_shipment_events_shipment ON order_intake.shipment_events (shipment_id, created_at DESC);
CREATE INDEX idx_shipment_events_tenant   ON order_intake.shipment_events (tenant_id, created_at DESC);
