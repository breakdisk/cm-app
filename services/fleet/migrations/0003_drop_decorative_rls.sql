...
DROP POLICY IF EXISTS fleet_tenant_isolation ON fleet.vehicles;
DROP POLICY IF EXISTS tenant_rls ON fleet.telematics_events;
DROP POLICY IF EXISTS tenant_rls ON fleet.fuel_records;

ALTER TABLE IF EXISTS fleet.vehicles DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS fleet.telematics_events DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS fleet.fuel_records DISABLE ROW LEVEL SECURITY;
