...
DROP POLICY IF EXISTS compliance_profiles_tenant_isolation ON compliance.compliance_profiles;
DROP POLICY IF EXISTS compliance_profiles_service_role ON compliance.compliance_profiles;

ALTER TABLE IF EXISTS compliance.compliance_profiles DISABLE ROW LEVEL SECURITY;
