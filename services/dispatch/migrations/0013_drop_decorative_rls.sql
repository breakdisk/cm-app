...
ALTER TABLE IF EXISTS dispatch.routes DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS dispatch.route_stops DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS dispatch.driver_assignments DISABLE ROW LEVEL SECURITY;
